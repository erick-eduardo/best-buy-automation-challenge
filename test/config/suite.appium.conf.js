...
exports.config = {
    ...
    cucumberOpts: {
        require: ['./test/stepDefinitions/*.steps.js'],   // <string[]> (file/dir)   files before executing features
        ...
        name: [],           // <string[]> ("extension:module")   files with the given EXTENSION after requiring MODULE (repeatable)
